...
public class JudgmentReaderTest {
    ...
    void readSingleTest() throws IOException, ParseException {
        var judgementReader = new JudgmentReader();
        ...
        assertEquals(judgement.getJudgmentType(), JudgmentType.SENTENCE);
    }

    @Test
    void readExcTest() {
        assertThrows(IndexOutOfBoundsException.class, () -> {
            JudgmentReader judgmentReader = new JudgmentReader();
            Judgement judgement = judgmentReader.readSingle(testFile, 1);
        });
        assertThrows(FileNotFoundException.class, () -> {
            JudgmentReader judgmentReader = new JudgmentReader();
            Judgement judgement = judgmentReader.readSingle(new File("filefilehey.json"), 0);
        });
    }
